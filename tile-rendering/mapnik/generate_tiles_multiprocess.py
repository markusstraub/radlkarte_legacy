...
if __name__ == "__main__":
    args = sys.argv[1:]
    if (len(args) < 2):
        print "usage: <scriptName> minZoom maxZoom [big]"
        sys.exit(2)
...
#    render_tiles(bbox, mapfile, tile_dir, 1, 11 , "Europe+")
    ...
    #Vienna
    if (len(args) > 2 and args[2] == 'big'):
        bbox = (16.2,48.1,16.6,48.3)
    else:  
        bbox = (16.35,48.2,16.4,48.22)
    render_tiles(bbox, mapfile, tile_dir, minZoom, maxZoom, "Vienna")
